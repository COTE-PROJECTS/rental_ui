                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <Image width={200} height={200} className="ml-[5px] w-8 flex-none" src="/assets/images/logo.svg" alt="logo" />
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">NyumbaYo</span>
                        </Link>
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <SidebarTile icon={<IconMenuWidgets className="shrink-0 group-hover:!text-primary" />} url="/widgets" label="Widgets" />
                            ...
                            <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span>HOUSE CATEGORIES</span>
                            </h2>
                            <SidebarTile icon={<IconFile className='' />} url='/categories' label='Categories' />
                            <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span>TENANTS DATA</span>
                            </h2>
                            {/* houses data */}
                            <SidebarTile icon={<IconHome className='' />} url='/houses' label='Houses' />
                            {/* tenants data */}
                            <SidebarTile icon={<IconUsers className='' />} url='/tenants' label='Tenants' />

                            <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span>PAYMENTS & REPORTS</span>
                            </h2>
                            {/* add tile for payments */}
                            <SidebarTile icon={<IconDollarSign className="shrink-0 group-hover:!text-primary" />} label='Payments' url='/payments' />
                            {/* REPORTS */}
