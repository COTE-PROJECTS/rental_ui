                                    ...
                                    <div className="p-5">
                                        <form>
                                            <div className='mt-3'>
                                                ...
                                                <input type="text" className='form-input' placeholder='first name here...' />
                                            </div>
                                            ...
                                            <div className='mt-3'>
                                                ...
                                                <input type="text" className='form-input' placeholder='last name here....' />
                                            </div>
                                            {/* Email */}
                                            <div className='mt-3'>
                                                <label className="form-label" htmlFor="title">
                                                ...
                                                <input type="email" className='form-input' placeholder='email here...' />
                                            </div>
                                            {/* contact */}
                                            <div className='mt-3'>
                                                <label className="form-label" htmlFor="title">
                                                ...
                                                <input type="text" className='form-input' placeholder='contact here .....' />
                                            </div>
                                            {/* house */}
                                            <div className='mt-3'>
                                                <label className="form-label" htmlFor="title">
                                            ...
                                            <div className='mt-3'>
                                                ...
                                                <input type="date" className='form-input' placeholder='registration date' />
                                            </div>
                                            {/* actions */}
