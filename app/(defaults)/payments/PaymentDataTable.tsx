                                    ...
                                    <div className="p-5">
                                        <form>
                                            ...
                                            <div className='mt-3'>
                                                ...
                                                <input type="text" className='form-input' placeholder='invoice' />
                                            </div>
                                            {/* months paid */}
                                            <div className='mt-3'>
                                                <label className="form-label" htmlFor="title">
                                                ...
                                                <input type="text" className='form-input' placeholder='paid months here...' />
                                            </div>
                                            {/* amount */}
                                            {/* invoice */}
                                            <div className='mt-3'>
                                                ...
                                                <input type="text" className='form-input' placeholder='000.00' />
                                            </div>
                                            {/* actions */}
